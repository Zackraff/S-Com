export function FeatureList() {
    return (
        <section className="max-w-5xl mx-auto px-6 py-12">
            <h3 className="text-4xl font-bold text-[#00FFFF] mb-12 text-center">
                Fitur Unggulan
            </h3>
            <ul className="space-y-8">
                <li className="bg-[#1F2A3E] p-6 rounded-lg shadow-lg hover:shadow-2xl">
                    ...
                    <article className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm mt-1">
                                ...
                                mendeteksi komentar promosi judi online.
                            </p>
                        </div>
                    </article>
                </li>
